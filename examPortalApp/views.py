...
6...) Figure out google cloud api for media
...
def open_test(request):
    ...
    if now<test_end:
        return render(request, "examPortalApp/testportal.html", {"UTCDate": test_end.day, "UTCMonth": test_end.month, "UTCYear": test_end.year, "UTCHours": test_end.hour, "UTCMinutes": test_end.minute, "UTCSeconds": test_end.second})
...
@login_required
def question_making_page(request):
    if request.user.username=="admin":
        return render(request, "examPortalApp/questionportal.html")
